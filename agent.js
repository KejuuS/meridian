...
const INTENT_TOOLS = {
  ...
  balance:     new Set(["get_wallet_balance", "get_my_positions", "get_wallet_positions", "reconcile_treasury"]),
  ...
  performance: new Set(["get_performance_history", "get_my_positions", "get_position_pnl", "reconcile_treasury"]),
...
const INTENT_PATTERNS = [
  ...
  { intent: "balance",     re: /\b(balance|wallet|sol|how much|reconcile|reconciliation|nav|net asset|net worth|audit)\b/i },
